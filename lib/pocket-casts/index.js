...
export function getCoverImagePath(uuid) {
  return {
    blurBase: `https://static.pocketcasts.com/discover/images/webp/200/${uuid}.webp`,
    coverImgUrl: `https://i0.wp.com/static.pocketcasts.com/discover/images/webp/960/${uuid}.webp`
  }
}
