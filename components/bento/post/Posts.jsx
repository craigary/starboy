    ...
    <Card className="h-full p-3" delay={delay}>
      <div className="flex h-full flex-col rounded-lg border transition-all hover:shadow-md hover:shadow-muted/50">
        <div className="shrink-0 overflow-hidden pb-4">
          <div
            className="relative z-10 flex items-center justify-between rounded-t-lg border-b bg-muted/30 p-3 shadow-sm
         after:absolute after:-bottom-5 after:-left-4 after:text-3xl after:font-black after:tracking-widest after:text-foreground/5 after:content-['...................................']"
          >
            ...
            <div
              className="absolute inset-0 z-0 h-full w-full overflow-hidden rounded-t-lg opacity-5"
              style={{
                backgroundImage:
