...
const ProjectCard = ({ delay }) => {
  return (
    <Card className="relative h-full p-3" delay={delay}>
      <div
        className="group relative z-10 flex h-full w-full flex-col items-center justify-end overflow-hidden rounded border border-border/50 bg-muted/20 transition-all hover:bg-muted/50
      "
      >
        <CardBg />
        <SiNotion
