...
const ProjectCard = ({ delay }) => {
  return (
    <Card className="relative h-full p-3" delay={delay}>
      <div
        className="group relative z-10 flex h-full w-full flex-col items-center justify-end overflow-hidden rounded-lg border
    bg-secondary/20 transition-all hover:scale-[102%] hover:shadow-md hover:shadow-muted/50
      "
      >
        <CardBg />
        <SiNotion
