...
const CornerCard = ({ delay }) => {
  return (
    <Card className="h-full p-3" delay={delay}>
      <div className="relative  h-full w-full rounded-lg border bg-gradient-to-br from-muted/0 via-muted/40 to-muted/0 transition-all hover:shadow-md hover:shadow-muted/50">
        <CardBg />
