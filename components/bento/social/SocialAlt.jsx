...
const SocialAltCard = async ({ delay = 0 }) => {
  ...
  return (
    <Card className="h-full p-3" delay={delay}>
      <div className="relative h-full w-full rounded-md border bg-transparent p-2 shadow-none transition-shadow hover:shadow-xl hover:shadow-muted/60 dark:bg-muted/20">
        <div className="mx-3 flex h-full items-center justify-center">
          <div className="flex items-end justify-center gap-3">
            ...
            <div className="rounded-xl rounded-bl-none border bg-background px-3 py-2 text-sm">
              {post.title}
            </div>
          </div>
        </div>
